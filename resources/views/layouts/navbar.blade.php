      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/csssample">° sampleCSS </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="themes">
                <a class="dropdown-item" href="https://bootswatch.com/">Bootwatch</a>
                <a class="dropdown-item" href="http://blog.bootswatch.com">Bootwatch Blog</a>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="download">° Simplex
                <span class="caret"></span>
              </a>
              <div class="dropdown-menu" aria-labelledby="download">
                <a class="dropdown-item" href="https://jsfiddle.net/bootswatch/3he50zsf/">Open in JSFiddle</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="https://bootswatch.com/4/simplex/bootstrap.min.css">bootstrap.min.css</a>
                <a class="dropdown-item" href="https://bootswatch.com/4/simplex/bootstrap.css">bootstrap.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="https://bootswatch.com/4/simplex/_variables.scss">_variables.scss</a>
                <a class="dropdown-item" href="https://bootswatch.com/4/simplex/_bootswatch.scss">_bootswatch.scss</a>
              </div>
            </li>
          </ul>
          ...
          <ul class="nav navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="/posts/create">Login</a>
            </li>
            <li class="nav-item">
